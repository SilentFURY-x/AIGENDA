...
genai.configure(api_key = "AIzaSyDeYnpxjDU7x3UTe_mTV2PDJ6ISCf8yRxY")
...
st.set_page_config(page_title="Fury's Invoice Generator")
st.sidebar.header("RoboBill")
st.sidebar.write("Made by FURY")
st.sidebar.write("Powered by Google Gemini")
st.header("RoboBill")
st.subheader("Made by FURY")
st.subheader("Manage your expenses wih RoboBill")
...
You have to greet the user first. Make sure to keep the fonts unifor and give the items list in a point-wise format.
